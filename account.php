...
<!-- Account -->
  <section class="my-5 py-5">
    <div class="row container mx-auto">
        <div class="text-center mt-4 pt-5 col-lg-6 col-md-12 col-sm-12">
            <p class="text-center" style="color:#66d855;"><?php if(isset($_GET['register_success'])){echo $_GET['register_success'];}?></p>
            <p class="text-center" style="color:#66d855;"><?php if(isset($_GET['login_success'])){echo $_GET['login_success'];}?></p>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            <form id="account-form" method="POST" action="account.php">
                ...
                <p class="text-center" style="color:#66d855;"><?php if(isset($_GET['message'])){echo $_GET['message'];}?></p>
